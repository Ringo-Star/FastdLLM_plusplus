...
# Set output path
OUTPUT_PATH="${OUTPUT_PATH:-exp/llava_v_eval}"
# Set task names
TASK_NAMES="${TASK_NAMES:-mmmu_val,mmmu_pro_standard,mmstar,ai2d,seedbench,mmbench_en_dev,mmmu_pro_vision,muirbench,videomme,mlvu_dev,mme,realworldqa,chartqa,docvqa_val,infovqa_val,mathvista_testmini,mathverse_testmini_vision}"
